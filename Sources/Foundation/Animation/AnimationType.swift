...
extension Animation {
    ...
    @MainActor
    public static func linear(_ speed: AnimationSpeed) -> Animation {
        .linear(duration: speed.rawValue)
    }

    @MainActor
    public static func easeIn(_ speed: AnimationSpeed) -> Animation {
        .easeIn(duration: speed.rawValue)
    }

    @MainActor
    public static func easeOut(_ speed: AnimationSpeed) -> Animation {
        .easeOut(duration: speed.rawValue)
    }

    @MainActor
    public static func easeInOut(_ speed: AnimationSpeed) -> Animation {
        .easeInOut(duration: speed.rawValue)
    }

    @MainActor
    public static func bouncy(_ speed: AnimationSpeed) -> Animation {
    ...
    public static func animate(
        ...
        duration: AnimationSpeed = .default,
        _ body: () -> Void
    ) async {
